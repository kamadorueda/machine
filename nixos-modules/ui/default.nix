{
  ...
  config = {
    ...
    home-manager.users.${config.wellKnown.username} = {
      ...
      xdg.userDirs.desktop = "${config.wellKnown.dataDir}/xdg/desktop";
      xdg.userDirs.documents = "${config.wellKnown.dataDir}/xdg/documents";
      xdg.userDirs.download = "${config.wellKnown.dataDir}/xdg/downloads";
      xdg.userDirs.enable = true;
      xdg.userDirs.music = "${config.wellKnown.dataDir}/xdg/music";
      xdg.userDirs.pictures = "${config.wellKnown.dataDir}/xdg/pictures";
      xdg.userDirs.publicShare = "${config.wellKnown.dataDir}/xdg/public-share";
      xdg.userDirs.templates = "${config.wellKnown.dataDir}/xdg/templates";
      xdg.userDirs.videos = "${config.wellKnown.dataDir}/xdg/videos";
    };
